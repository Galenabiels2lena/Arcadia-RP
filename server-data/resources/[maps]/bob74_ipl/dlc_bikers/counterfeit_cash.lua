...
BikerCounterfeit = {
    ...
    LoadDefault = function()
        ...
        BikerCounterfeit.Printer.Set(BikerCounterfeit.Printer.upgradeProd, true)
        BikerCounterfeit.Security.Set(BikerCounterfeit.Security.upgrade, true)
        ...
        BikerCounterfeit.Details.Enable(BikerCounterfeit.Details.Cash100.A, true, true)
        BikerCounterfeit.Details.Enable(BikerCounterfeit.Details.Cash100.B, true, true)
        BikerCounterfeit.Details.Enable(BikerCounterfeit.Details.Cash100.C, true, true)
        BikerCounterfeit.Details.Enable(BikerCounterfeit.Details.Cash100.D, true, true)
